      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
              ...
              <div class="card-body">
                <form>
                  <div class="form-group">
                    <input class="form-control" id="username" type="text" placeholder="Tài khoản" autocomplete="off">
                  </div>
                  <div class="form-group">
            ...
            <div class="splash-footer"><span>Không có tài khoản? <a href="pages-sign-up.html">Đăng ký</a></span></div>
          </div>
        </div>
      </div>
    </div>
